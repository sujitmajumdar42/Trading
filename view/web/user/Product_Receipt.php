<!--<div style="border: 1px solid #000;padding: 10px; width: 800px; font-size: small">
<div id="RCP_Header"style="border-bottom: 1px solid #5f9cc5;height: 150px; width: 800px">
    <div id="RCP_Logo" style="width: 40%; float: left; text-align: center;">
    ...
    <div id="RCP_SubHeader" style="width:60%; float: left; margin-top: 50px;text-align: right">
        <input type="checkbox"><i>Original For</i> : Buyer <br/>
        <input type="checkbox"><i>Duplicate For</i> : Transporter <br/>
        <input type="checkbox"><i>Triplicate For</i> : Office Filing <br/>
    </div>
</div>
    <div style="height: 0px">&nbsp;</div>
<div style="height: 50px; width: 800px; border-bottom: 1px solid #000">
    <div style="width: 40%; float: left; text-align: center"><h2>TAX INVOICE</h2></div>
    <div style="width:20%;float: right; margin-top: 30px; text-align: right"><i>TIN No</i> :  21392901248</div>
</div>
<div>&nbsp;</div>
<div style="height: 170px; width: 800px; border-bottom: 1px solid #000">
    <div style="width: 50%; float: left; text-align: center">
        Goods Shipped to :<textarea style="height: 50px">M/S. : METTO SUPER MARKET PVT. LTD.,Bhubaneswar</textarea>  

        <br/><br/>
        VAT TIN NO : <input type="text"><br/>
        CST TIN NO : <input type="text"><br/>
    </div>
    <div style="width:50%;float: right; margin-top: 30px; text-align: right">
        INVOICE NO : 1 &nbsp; Date : 8/4/2014<br/>
...
<!--<table>
   ...
   <tbody id="RCP_Shipping"></tbody>
   <tbody id="RCP_Address"></tbody>
   <tbody id="RCP_Prod_Heading"></tbody>
   <tbody id="RCP_Prod_Total"></tbody>
   <tbody id="RCP_Footer"></tbody>
</table>-->